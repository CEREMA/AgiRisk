...
-- Fonction SQL permettant de générer en une fois les représentations cartographiques de tous les indicateurs pour tous les types d'aléa et toutes les occurrences de crue sur un territoire donné
...
-- SELECT public.__indic_rc_all_fct('Baccarat''IRIS', '2022');
-- SELECT public.__indic_rc_all_fct('Cap Atlantique', '2022');
-- SELECT public.__indic_rc_all_fct('CARENE', '2022');
-- SELECT public.__indic_rc_all_fct('CC_GST', '2022');
-- SELECT public.__indic_rc_all_fct('CDA La Rochelle - CDC Aunis Atlantique', '2022');
-- SELECT public.__indic_rc_all_fct('Clain amont', '2022');
-- SELECT public.__indic_rc_all_fct('Communauté de Communes Terre Lorraine du Longuyonnais', '2022');
-- SELECT public.__indic_rc_all_fct('Jura', '2022');
-- SELECT public.__indic_rc_all_fct('Longuyon', '2022');
-- SELECT public.__indic_rc_all_fct('Scot de Tours', '2022');
-- SELECT public.__indic_rc_all_fct('Sequana', '2022');
-- SELECT public.__indic_rc_all_fct('Sequana Ource et Digeanne', '2022');
-- SELECT public.__indic_rc_all_fct('Sequana Seine et Brevon', '2022');
-- SELECT public.__indic_rc_all_fct('TRI Baccarat secteur 54', '2022');
-- SELECT public.__indic_rc_all_fct('TRI Nancy Damelevieres', '2022');
-- SELECT public.__indic_rc_all_fct('TRI Noirmoutier SJDM', '2022');
-- SELECT public.__indic_rc_all_fct('TRI Verdun', '2022');
-- SELECT public.__indic_rc_all_fct('Vienne Clain', '2022');
-- SELECT public.__indic_rc_all_fct('Wissant', '2022');
-- SELECT public.__indic_rc_all_fct('Zorn', '2022');
