...
-- CALL public.__indic_all('Baccarat''IRIS', '2022', '2022');
-- CALL public.__indic_all('Cap Atlantique', '2022', '2022');
-- CALL public.__indic_all('CARENE', '2022', '2022');
-- CALL public.__indic_all('CC_GST', '2022', '2022');
-- CALL public.__indic_all('CDA La Rochelle - CDC Aunis Atlantique', '2022', '2022');
-- CALL public.__indic_all('Clain amont', '2022', '2022');
-- CALL public.__indic_all('Communauté de Communes Terre Lorraine du Longuyonnais', '2022', '2022');
-- CALL public.__indic_all('Jura', '2022', '2022');
-- CALL public.__indic_all('Longuyon', '2022', '2022');
-- CALL public.__indic_all('Scot de Tours', '2022', '2022');
-- CALL public.__indic_all('Sequana', '2022', '2022');
-- CALL public.__indic_all('Sequana Ource et Digeanne', '2022', '2022');
-- CALL public.__indic_all('Sequana Seine et Brevon', '2022', '2022');
-- CALL public.__indic_all('TRI Baccarat secteur 54', '2022', '2022');
-- CALL public.__indic_all('TRI Nancy Damelevieres', '2022', '2022');
-- CALL public.__indic_all('TRI Noirmoutier SJDM', '2022', '2022');
-- CALL public.__indic_all('TRI Verdun', '2022', '2022');
-- CALL public.__indic_all('Vienne Clain', '2022', '2022');
-- CALL public.__indic_all('Wissant', '2022', '2022');
-- CALL public.__indic_all('Zorn', '2022', '2022');
