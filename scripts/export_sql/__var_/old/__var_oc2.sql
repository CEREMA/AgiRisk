...
-- Exemple d'appel à cette fonction : SELECT public.__var_oc2('Jura', '2021', '2022');
...
BEGIN
    ...
    RAISE NOTICE 'Calcul Oc2 sur le territoire ''%''', nom_ter;
	...
	(
		...
		WHERE territoire = '''||nom_ter||'''
			...
			AND (nb_logts != 0 OR nb_logts IS NULL)
