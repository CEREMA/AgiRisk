CREATE OR REPLACE FUNCTION public.__var_oc3_aurel(nom_ter text, an_lien text, an_bdtopo text, an_siren text)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
...
-- an_adresse = millésime (année au format AAAA) de la base ADRESSE PREMIUM
-- an_bdtopo = millésime (année au format AAAA) de la BD TOPO®

-- Exemple d'appel à cette fonction : SELECT public.__var_oc3('Jura', '2022', '2022', '2022');
...
BEGIN
	...
	RAISE NOTICE 'début traitement "%"', heure1;
...
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-- Partie de code modifiée par Aurélien le 22/03/2023 lors du séminaire AgiRisk, pour optimiser le temps de calcul (ici, réduction d'environ de moitié du temps de calcul)

	RAISE NOTICE '--3. création de la couche adresse sur le territoire';

	EXECUTE 'DROP TABLE IF EXISTS decode_adresse';
	EXECUTE 'CREATE TEMP TABLE decode_adresse AS
		SELECT 
			...
			END as adresse_ban,
			a.id,numero as numero_ban,rep,code_post,code_insee,a.geom		
...
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	RAISE NOTICE '[INFO] La table oc3 (enteprises rattachées aux bâtiments de la BDTOPO) a été mise à jour sur le territoire de "%".', nom_ter;
	RAISE NOTICE '';
