CREATE OR REPLACE PROCEDURE public.__var_all_lucie(IN nom_ter text, IN an_ff text, IN an_fch_acb text, IN an_lien text, IN an_bdtopo text, IN an_gpu text, IN an_iris text, IN an_rpg text, IN an_pop text, IN an_siren text, IN an_topage text)
 LANGUAGE plpgsql
AS $procedure$
...
-- CALL public.__var_all('Baccarat''IRIS', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('Clain amont', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('Jura', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('Sequana', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('Sequana Seine et Brevon', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('TRI Baccarat secteur 54', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('TRI Noirmoutier SJDM', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('TRI Verdun', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('Vienne Clain', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
-- CALL public.__var_all('Zorn', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019');
...
/*	BEGIN
	...
	/*BEGIN
		...
		RAISE NOTICE '====== Calcul de la variable Oc5 (campings et aires d''accueil des gens du voyage) ======';
			...
			EXECUTE 'SELECT public.__var_oc5('''||REPLACE(nom_ter,'''','''''')||''', '''||an_bdtopo||''')';
			COMMIT;
