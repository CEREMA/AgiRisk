...
CREATE OR REPLACE PROCEDURE public.__var_all(IN nom_ter text, IN an_ff text, IN an_fch_acb text, IN an_lien text, IN an_bdtopo text, IN an_gpu text, IN an_iris text, IN an_rpg text, IN an_pop text, IN an_siren text, IN an_topage text, IN an_osm text)
 LANGUAGE plpgsql
AS $procedure$

-- Procédure SQL permettant de calculer en une fois toutes les variables sur un territoire donné (exécution à la suite de toutes les fonctions d'incrémentation des tables des variables)
...
-- CALL public.__var_all('Baccarat''IRIS', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Cap Atlantique', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('CARENE', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('CC_GST', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('CDA La Rochelle - CDC Aunis Atlantique', '2022', '2022', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023'); -- Fonctionne au 24/08/2023
-- CALL public.__var_all('Clain amont', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Communauté de Communes Terre Lorraine du Longuyonnais', '2022', '2022', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Jura', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Longuyon', '2022', '2022', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Scot de Tours', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Sequana', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Sequana Ource et Digeanne', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Sequana Seine et Brevon', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('TRI Baccarat secteur 54', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('TRI Nancy Damelevieres', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('TRI Noirmoutier SJDM', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('TRI Verdun', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Vienne Clain', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Wissant', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
-- CALL public.__var_all('Zorn', '2021', '2021', '2022', '2022', '2022', '2022', '2021', '2015', '2022', '2019','2023');
...
BEGIN
	...
	BEGIN
		...
		-- NOTA : oc2 est un champ booléen de la table oc1. Une table oc2_amc est créée dans le schéma c_occupation_sol.
			EXECUTE 'DELETE FROM c_occupation_sol.oc2_amc WHERE territoire = '''||REPLACE(nom_ter,'''','''''')||'''';
	...
	BEGIN
		...
		-- NOTA : oc2 est un champ booléen de la table oc1. Il n'y pas de création de table oc2_ref en tant que telle.
			EXECUTE 'DELETE FROM c_occupation_sol.oc2_ref WHERE territoire = '''||REPLACE(nom_ter,'''','''''')||'''';
	...
	BEGIN
		...
		-- NOTA : la fonction __var_oc3 crée une table oc3 sans géométrie, servant à l'identification des bâtiments d'activité et au calcul du nombre d'employés. Elle met à jour le champ oc3 (booléen) de la table oc1. pop2 est décliné en pop2_haut et pop2_bas qui sont deux champs attributaires de la table oc1. Il n'y a pas de création de table pop2 en tant que telle.
			EXECUTE 'DELETE FROM c_occupation_sol.oc3 WHERE territoire = '''||REPLACE(nom_ter,'''','''''')||'''';
