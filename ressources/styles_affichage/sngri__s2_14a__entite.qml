...
<qgis version="3.22.6-Białowieża" styleCategories="Symbology">
  <renderer-v2 type="RuleRenderer" symbollevels="0" enableorderby="0" referencescale="-1" forceraster="0">
    <rules key="{c9f9ea8c-e957-41b3-a7a9-f6c1dc507b5d}">
      <rule symbol="0" label="En zone inondable" key="{2e833353-c42c-4396-960a-967d816b536f}" filter="&quot;loc_zx&quot; = 'In'"/>
      <rule symbol="1" label="Hors zone inondable" key="{fab31a4f-ac77-4a4a-857c-f4c16848e159}" filter=" &quot;loc_zx&quot; =  'Out'"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" type="fill" name="0" clip_to_extent="1" alpha="0.7">
