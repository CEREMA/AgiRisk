...
<qgis labelsEnabled="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" version="3.16.14-Hannover" minScale="100000000" readOnly="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 type="categorizedSymbol" enableorderby="0" attr="duree_subm" symbollevels="0" forceraster="0">
    <categories>
      <category value="&lt;48h" render="true" symbol="0" label="&lt;48h"/>
      <category value=">48h" render="true" symbol="1" label=">48h"/>
    </categories>
    <symbols>
      <symbol type="fill" force_rhr="0" name="0" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="42,210,126,255"/>
  ...
  <customproperties>
    <property value="&quot;description_alea&quot;" key="dualview/previewExpressions"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="duree_subm">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="6" name="" field="duree_subm"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="duree_subm" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint notnull_strength="0" unique_strength="0" constraints="0" exp_strength="0" field="duree_subm"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="duree_subm" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction value="{00000000-0000-0000-0000-000000000000}" key="Canvas"/>
  </attributeactions>
  <attributetableconfig sortExpression="&quot;code_occurrence&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" name="code_occurrence" width="177" hidden="0"/>
      <column type="field" name="type_alea" width="282" hidden="0"/>
      <column type="field" name="description_alea" width="244" hidden="0"/>
      <column type="field" name="duree_subm" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="duree_subm" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="duree_subm"/>
